    ...
    <div>
        ...
        ?>
            ...
            <table cellspacing=0 cellpadding=0 style='margin-left:20pt;border-collapse:collapse;border:none'>
                ...
                <tr>
                    <td>Sumber Dana</td>
                    <td>: <?php if ($p->sumber_dana == 1) {
                                echo "APBD";
                            } else {
                                echo "APBD-P";
                            }
                            echo " Kab. Pangandaran Tahun Anggaran " . date('Y', strtotime($tglba)) ?></td>
                </tr>
                <tr>
                    <td>Nilai Pekerjaan</td>
                    <td>: <?php echo "Rp." . number_format($p->nilai_kontrak, 0, ',', '.'); ?></td>
                </tr>
                <tr>
                    <td>Terbilang</td>
            ...
            <table cellspacing=0 cellpadding=0 style='margin-left:20pt;margin-bottom:0;border-collapse:collapse;border:none' width="80%">
                <tr>
                    ...
                    <td style="text-align:right">Rp. <?php echo number_format(round($dpp, 0),  0, ',', '.') ?></td>
                </tr>
                <tr>
                    <td> PPN</td>
                    <td style="text-align:right">Rp. <?php echo number_format(round($ppn, 0),  0, ',', '.') ?></td>
                </tr>
                <tr>
                    <td>Total</td>
                    <td style="text-align:right"><b>Rp. <?php echo number_format($p->nilai_kontrak,  0, ',', '.') ?></b></td>
                </tr>
            </table>
